...
using AuthenticationService = ContactPro.Domain.Services.AuthenticationService;
using IAuthenticationService = ContactPro.Domain.Services.Interfaces.IAuthenticationService;
