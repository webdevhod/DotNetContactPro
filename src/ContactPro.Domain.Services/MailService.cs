...
public class MailService : IMailService
{
    ...
    public virtual async Task SendPasswordResetMail(User user)
    {
        ...
        await _emailService.SendEmailAsync(user.Email, "ContactPro password reset", message);
    ...
    public virtual async Task SendActivationEmail(User user)
    {
        ...
        await _emailService.SendEmailAsync(user.Email, "ContactPro account activation is required", message);
    ...
    public virtual async Task SendCreationEmail(User user)
    {
        ...
        await _emailService.SendEmailAsync(user.Email, $"ContactPro account {user.Login} created", message);
